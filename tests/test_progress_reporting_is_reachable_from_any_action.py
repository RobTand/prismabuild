...
# The synthetic actions here run as themselves, not as the action that
# admitted the suite: ``tests/conftest.py``'s ``_standalone_action_identity``
# scrubs the ambient broker-owned reader tuple for every test (#786, #802).
