...
measurement stages. On 2026-09-05, commit `9643a3b` (nine commits on top of
`18194a0`) recorded 1071 passed and 3 skipped in its CPU suite on sparky and
the same on dl380g10; that dated population is evidence, not a permanent
suite-count claim. It names a commit rather than a branch because a merged
